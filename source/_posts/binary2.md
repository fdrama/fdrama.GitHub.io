...
| 符号位S |          指数 | 实际指数 |  指数域E  |           尾数域M            |   数值    |             含义             |
| :-----: | ------------: | :------: | :-------: | :--------------------------: | :-------: | :--------------------------: |
|    0    | $e=e^{min}-1$ |    0     | 0000 0000 | 000 0000 0000 0000 0000 0000 |    +0     |            正数0             |
|    1    | $e=e^{min}-1$ |    0     | 0000 0000 | 100 0000 0000 0000 0000 0000 |    -0     |            负数0             |
...
0.4_{D} = 0.11001100110011001100110..._{B} \quad &再转换小数位 \\\\
0.4_{D} = 0.011001100110011001100110..._{B} （0011 无限循环） \quad &组合起来 \\\\
